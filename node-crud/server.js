...
app.get("/cards/:id", (req, res) => {
    ...
    if (card) {
        res.status(200).json({ message: "card retrieved successfully", card: card });
    } else {
...
app.put("/cards/:id", (req, res)=>{
    ...
    if(cardIndex!=-1){
        ...
        res.status(200).json({ message: "card updated successfully", card: updateCard });
    }
    else{
        res.status(404).json({ message: "card not found" });
    }
...
app.delete('/cards/:id',(req,res)=>{
    ...
    if(cardIndex!=-1){
        ...
        res.status(200).json({ message: "card deleted successfully", card: deleteCard[0] });
    }
    else{
        res.status(404).json({ message: "card not found" });
    }
